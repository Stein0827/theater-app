...
exports.updateConcession = void 0;
const ConcessionModel_1 = require("../models/ConcessionModel");
const updateConcession = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const concessionModel = new ConcessionModel_1.ConcessionModel(data);
        const newConcession = yield concessionModel.updateConcession();
